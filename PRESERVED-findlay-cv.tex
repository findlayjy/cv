...
\begin{cvsection}
      ...
      % (co-ordinating and delivering tutorial teaching, as well as setting and marking the final exam).\\
\end{cvsection}
...
\Label{Manuscript\\[-0.5ex] reviewer} &
                    ...
                    \textit{Journal of Linguistics}~(2015, 2017, 2019).
                     \\
\Label{Abstract\\[-0.5ex] reviewer}   &
                    \textit{International Lexical Functional Grammar Conference} (2019, 2020),
