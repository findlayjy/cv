...
\begin{cvsection}
  ...
  \Label{Chair} & Executive Committe, International Lexical Functional Grammar Association (ILFGA) (Sept.~2023--Aug.~2024).\\
...
\Reff*{dmr23-paper}{To appear}{Dag T. T. Haug, Jamie Y. Findlay, and Ahmet
  Y\i{}ld\i{}r\i{}m.
  \linkout{https://dmr2023.github.io/pdf/2023.dmr-1.9.pdf}{The long and the
    short of it: \textsc{drastic}, a semantically annotated dataset containing
    sentences of more natural length.} To appear in \emph{Proceedings of the
    Fourth International Workshop on Designing Meaning Representations (DMR
    2023)}, 89--98.}

\Reff*{lfg-tag-chapter}{To appear}{Jamie Y. Findlay.
  \linkout{https://langsci-press.org/catalog/view/312/4372/2656-1}{LFG and Tree
    Adjoining Grammar}. To appear in Mary Dalrymple (ed), \emph{Handbook of
    Lexical Functional Grammar}. Language Science Press.}

\Reff*{arg-str-handbook-chapter}{To appear}{Jamie Y. Findlay, Roxanne Taylor,
  and Anna Kibort. \mydraftslink{findlay_etal-arg-str-ch-prepub.pdf}{Argument
    structure and Mapping Theory}. To appear in Mary Dalrymple (ed.),
  \emph{Handbook of Lexical Functional Grammar}. Language Science Press.}

\Reff*{lfg-as-a-cxg}{To appear}{Jamie Y. Findlay.
  \mydraftslink{findlay-lfg-as-cxg-draft.pdf}{Lexical Functional Grammar as a
    Construction Grammar}. To appear in \textit{Journal of Language Modelling}.}

\Reff*{lfg23-paper}{In prep.}{Jamie Y. Findlay. Lexical integrity is the norm:
  or, ``violating lexical integrity in a specific and limited way''. To appear
  in \textit{Proceedings of the LFG'23 Conference}.}
...
\Reff{meaning-in-lfg-chapter}{2021}{Jamie Y. Findlay.
  \mypaperslink{findlay-2021-meaning_in_lfg.pdf}{Meaning in LFG}. \raggedright In I. Wayan Arka,
  Ash Asudeh, and Tracy Holloway King (eds.), \emph{Modular design of grammar:
    linguistics on the edge}, 340--374. Oxford University Press.
  \doi{10.1093/oso/9780192844842.003.0020}. \hfill[1 citation]}
...
\Reff{house-of-lords-paper}{2017}{Jamie Y. Findlay.
  ...
  \doi{10.1075/jls.6.1.02fin}. \hfill[17 citations]}
...
\Reff{arg-str-paper}{2016}{Jamie Y. Findlay.
  ...
  \doi{10.15398/jlm.v4i2.171}. \hfill[44 citations]}

\Reff{bmj-paper}{2013}{Janak Bechar, Jamie Y. Findlay, and Joseph Hardwicke.
  \linkout{https://doi.org/10.1136/sbmj.f7394}{Understanding medical words of
...
\Reff{lfg2020}{2020}{Jamie Y. Findlay.
 \href{http://web.stanford.edu/group/cslipublications/cslipublications/LFG/LFG-2020/lfg2020-findlay.pdf}{Mapping
  ...
  Stanford, CA: CSLI Publications. \hfill[11 citations]}
...
\Reff{headlex}{2016}{Jamie Y. Findlay.
 \linkout{https://proceedings.hpsg.xyz/article/view/533}{The
  ...
  Publications. \hfill[9 citations]}

\subsection*{Invited Talks}

\Reff*{konstanz-colloquium-2023}{16 Nov., 2023}{If it ain't broke, don't fix it:
  on the continued relevance of rule-based semantic parsers in the age of deep
  learning. To be presented at the Department of Linguistics Department and
  Research Colloquium (Fachbereichs- und Forschungsgruppenkolloquium),
