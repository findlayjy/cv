...
\begin{cvsection}
  \longdate{01/11/2024--\\present}    & \textbf{Associate Professor (\emph{Førsteamanuensis}) in Linguistics}, University of Oslo.\\
  \longdate{01/04/2021--\\31/10/2024} & \textbf{Postdoctoral Researcher (\emph{Postdoktor}) in Computational Semantics}, University of Oslo.\\
...
\begin{cvsection}
  ...
  & At the graduate level, I have created and led courses in \textbf{(computational) syntax} and \textbf{formal approaches to sociolinguistic variation}, as well as TA-ing for courses in \textbf{syntax}, \textbf{phonology}, and \textbf{formal foundations of linguistics} (an introduction to set theory, logic, and formal language theory for linguists).\\
...
\rulesubhead{Summer schools}

\cvsubhead{European Summer School in Logic, Language and Information (ESSLLI)}

\begin{cvsection}
  2025 & \Note{\textbf{An introduction to Glue Semantics: theoretical and
      computational perspectives}}%
  {Taught jointly with Mark-Matthias Zymla. Course materials available
    \linkout*{https://github.com/findlayjy/glue-esslli-2025/}{here}.\hfill{\normalsize(classes
      -- group size: \textasciitilde{}12)}}
\end{cvsection}
...
\begin{cvsection}
  2025 & \Note{\textbf{Computational Lexical Functional Grammar}\hfill(classes -- group size: 8)}{[LING4170: Linguistics specialization on structure and form]}\\
...
\begin{cvsection}
  2024--2025 & \Note{\textbf{Linguistic method}\hfill (lecture -- group size: \textasciitilde{}20)}{[LING4140: Språkvitenskapelig metode] -- lectures on `Modelling in the language sciences' and `Corpus linguistics'.}\\
...
\begin{cvsection}
  2024--2025 & \Note{\textbf{Formal semantics and pragmatics} \hfill(classes -- group size: \textasciitilde{}10)}%
  {[LING2100: Fordypning i semantikk og pragmatikk]}
\end{cvsection}

\cvsubsubhead{As joint primary instructor}

\begin{cvsection}
  2025 & \Note{\textbf{Introduction to morphology and syntax} \hfill(lectures -- group size: \textasciitilde{}30)}{[LING1112: Innføring i morfologi og syntaks]}\\
  2025  & \Note{\textbf{Linguistic theories} \hfill(classes -- group size: \textasciitilde{}12)}{[LING2200: Lingvistiske teorier] -- 2 classes on formal language theory.}\\
...
\begin{cvsection}
 \longdate{06/03/2025} & \Note{%
    \textbf{Carpentries@UiO -- Introduction to the Unix shell} \hfill (class --
    group size: \textasciitilde{}10)} {An introduction to Bash and shell
    scripting for researchers.
    \linkout*{https://uio-carpentry.github.io/2026-03-06-uio/}{Course website}.}\\
\end{cvsection}
...
\begin{cvsection}
  2025 & Jovana Knutsen. M.A. thesis. Title:~\textit{Ergonomics of
    discourse: measuring interpreter load indices in human- and large language
...
% \cvheading{Outreach/Impact}

% \begin{cvsection}
%   30/01/2026 & \textbf{Panel discussant}, \emph{Mellom ytring og fortelling: kommunikasjon med og om KI} ('Between utterance and narrative: communication with and about AI'). Public event at Domus Bibliotheca, Oslo.
% \end{cvsection}
...
\begin{cvsection}
  ...
  October 2025-- & \Note{\textbf{Departmental Canvas contact}}{Contact person in the department responsible for providing assistance and oversight w.r.t. digital teaching design\\[-0.5em] in Canvas, our Learning Management System.}\\
  June 2025-- & \Note{\textbf{\emph{N\o kkelperson for digital kompetanse}}}{One of several `key persons' in the department responsible for contributing to greater digital competence among\\[-0.5em] staff and students, including the responsible use of AI tools.}\\
...
\begin{cvsection}
  ...
  2012--2024 & Canadian Linguistic Association (CLA\slash ACL).\\
\end{cvsection}
...
\Reff{lfg-as-a-cxg}{2023}{Jamie Y. Findlay.
  \linkout{https://jlm.ipipan.waw.pl/index.php/JLM/article/view/338/279}{Lexical
    ...
    Modelling} 11(2), 197--266. \doi{10.15398/jlm.v11i2.338}.\hfill[4 citations]}
...
\Reff{meaning-in-lfg-chapter}{2021}{Jamie Y. Findlay.
  ...
  Press. \doi{10.1093/oso/9780192844842.003.0020}. \hfill[3 citations]}
...
\Reff{house-of-lords-paper}{2017}{Jamie Y. Findlay.
  \mypaperslink{house\_of\_lords.pdf}{Unnatural acts lead to unconsummated
  ...
  \doi{10.1075/jls.6.1.02fin}. \hfill[28 citations]}
...
\Reff{arg-str-paper}{2016}{Jamie Y. Findlay.
  ...
  4(2), 293--338. \doi{10.15398/jlm.v4i2.171}. \hfill[59 citations]}
...
\Reff{lfg25-paper}{2025}{Mary Dalrymple, Jamie Y. Findlay, and Dag T. T. Haug.
  \linkout{https://lfg-proceedings.org/lfg/index.php/main/article/view/75/68}{Constraining
    scope in Glue Semantics}. In Miriam Butt, Jamie Y. Findlay, and Ida Toivonen
  (eds.), \emph{Proceedings of the LFG'25 Conference}, 110--131. Konstanz:
  PubliKon. \doi{10.18148/lfg/2025.v30i.75}}

\Reff{udw25-paper}{2025}{Jamie Y. Findlay and Dag T. T. Haug.
  \linkout{https://aclanthology.org/2025.udw-1.8/}{Negation in Universal
    Dependencies}. In \textit{Proceedings of the Eighth Workshop on Universal
    Dependencies (UDW, SyntaxFest 2025)}, 70–79. Association for Computational
  Linguistics.}
...
\Reff{semantics-for-dep-gram}{2023}{Dag T. T. Haug and Jamie Y. Findlay.
  \linkout{https://aclanthology.org/2023.depling-1.3/}{Formal semantics for
    Dependency Grammar}. In \textit{Proceedings of the Seventh International
    Conference on Dependency Linguistics (Depling, GURT\slash SyntaxFest 2023)},
  22--31. Association for Computational Linguistics. \hfill[1 citation]}
...
\Reff{lfg22-paper}{2022}{Jamie Y. Findlay and Dag T. T. Haug.
  ...
  143--163. Stanford, CA: CSLI Publications. \doi{10.18148/lfg/2022.v27i.18}
  \hfill[3 citations]}
...
\Reff{lfg2020}{2020}{Jamie Y. Findlay.
 \href{http://web.stanford.edu/group/cslipublications/cslipublications/LFG/LFG-2020/lfg2020-findlay.pdf}{Mapping
  ...
  Stanford, CA: CSLI Publications. \hfill[14 citations]}
...
\Reff{headlex}{2016}{Jamie Y. Findlay.
  \linkout{https://proceedings.hpsg.xyz/article/view/533}{The prepositional
    passive in Lexical Functional Grammar}. In Doug Arnold, Miriam Butt,
  Berthold Crysmann, Tracy Holloway King, and Stefan M\"uller (eds.),
  ...
  Publications. \doi{10.21248/hpsg.2016.14} \hfill[12 citations]}
...
\Reff{lsa23-proceedings}{2023}{Yoolim Kim and Jamie Y. Findlay.
  ...
  \doi{10.3765/plsa.v8i1.5534}. \hfill[4 citations]}
...
\Reff*{udw25-talk}{27 Aug., 2025}{Negation in Universal Dependencies. Joint work
  with Dag T. T. Haug. Presented at the Eighth Workshop on Universal
  Dependencies (UDW, SyntaxFest 2025), University of Ljubljana.
  \slides{udw25-slides.pdf}}

\Reff*{lfg25-talk}{23 July, 2025}{Constraining scope in Glue Semantics: the
  linear logic approach. Joint work with Mary Dalrymple and Dag T. T. Haug.
  Presented at the 30th International Lexical Functional Grammar Conference,
  Universitat Pompeu Fabreu, Barcelona, Spain. \poster{lfg25-poster.pdf}}
