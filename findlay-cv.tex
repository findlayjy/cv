...
\newcommand{\myrepo}{https://jyfindlay.com/papers} % github papers repo
...
\begin{cvsection}
  ...
  {Mapped to Descriptor 1 of the UK Professional Standards Framework: equivalent to Associate Fellow\\[-0.5em] of the Higher Education Academy.\\
    ...
    \myteachinglink*{portfolio-JYF-submission.pdf}{here}. }%
\end{cvsection}
...
\begin{cvsection}
  ...
  2021 & \Note{\textbf{Psycholinguistics and Sociolinguistics} (lectures --
...
Where possible, clicking on a title will take you to an openly accessible
version of that item. For conference presentations, I provide a link to the
slides, handout, or poster, as appropriate.\medskip
...
\Reff*{lfg-tag-chapter}{In press}{Jamie Y. Findlay.
  \mydraftslink{findlay-tag-lfg-ch-draft.pdf}{LFG and Tree Adjoining Grammar}. In Mary
...
\Reff*{lfg-as-a-cxg}{Under review}{Jamie Y. Findlay.
  \mydraftslink{findlay-lfg-as-cxg-draft.pdf}{Lexical Functional Grammar as a
...
\Reff*{arg-str-handbook-chapter}{Under review}{Jamie Y. Findlay, Anna Kibort and
  Roxanne Taylor. \mydraftslink{findlay_etal-arg-str-ch-draft.pdf}{Argument structure
...
\Reff{meaning-in-lfg-chapter}{2021}{Jamie Y. Findlay.
  \mypaperslink{mary-festschrift-chapter.pdf}{Meaning in LFG}. In I. Wayan Arka, Ash
...
\Reff{house-of-lords-paper}{2017}{Jamie Y. Findlay.
  \mypaperslink{house_of_lords.pdf}{Unnatural acts lead to unconsummated marriages:
...
\Reff{lsa23-proceedings}{2023}{Yoolim Kim and Jamie Y. Findlay.
  \mypaperslink{kim_findlay-2023-on_the_subject_honorific_si_in_korean.pdf}{On
    the `subject' honorific \textit{-si-} in Korean}. \textit{Proceedings of the
    Linguistic Society of America (PLSA)} 8(1), 5534.
  DOI: \href{https://doi.org/10.3765/plsa.v8i1.5534}{10.3765/plsa.v8i1.5534}}
