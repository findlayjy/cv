...
\begin{cvsection}
  ...
  (\sref{depling21}), and will present a new theoretical approach to handling
  scope islands in Glue Semantics at the LFG conference this year
  (\sref{lfg22-talk}).
\end{cvsection}
...
\begin{cvsection}
  ...
  % 2022  & \Note{\textbf{Language change}}{[LING2108: Språkendring]}
\end{cvsection}
...
\Label{Manuscript reviewer} &
                ...
                \item \textit{Handbook of Lexical Functional Grammar} [Language Science Press]~(two chapters: 2020, 2022),
...
\Reff{lfg2020}{2020}{Jamie Y. Findlay.
  ...
  Stanford, CA: CSLI Publications. \hfill[6 citations]}
...
\Reff*{lfg22-talk}{12--14 July, 2022}{Managing scope ambiguities in Glue via
  multistage proving. Joint work with Dag T. T. Haug. To be presented at the
  27th International Lexical Functional Grammar Conference, University of
  Groningen.}
...
\Reff*{selfg32}{21 May, 2022}{Managing scope ambiguities in Glue via multistage
  proving . Joint work with Dag T. T. Haug. To be presented at the 32nd South of
