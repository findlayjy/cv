...
\begin{cvsection}
  % \longdate{01/11/2024--\\present}    & \textbf{Associate Professor (Førsteamanuensis) in Computational Linguistics}, University of Oslo.\\
  \longdate{01/04/2021--\\present} & \textbf{Postdoctoral Researcher (Postdoktor) in Computational Semantics}, University of Oslo.\\
...
\begin{cvsection}
  \Label{Natural} & English~(native), French~($\geq$C1), Norwegian~(A2/B1),
  Latin~(intermediate), German~(A1).
  \\
...
\Reff{house-of-lords-paper}{2017}{Jamie Y. Findlay.
  ...
  \doi{10.1075/jls.6.1.02fin}. \hfill[21 citations]}
...
\Reff{arg-str-paper}{2016}{Jamie Y. Findlay.
  ...
  4(2), 293--338. \doi{10.15398/jlm.v4i2.171}. \hfill[55 citations]}
