...
\begin{cvsection}
  % 2025 & \Note{\textbf{Computational Lexical Functional Grammar}\hfill(seminars -- group size: ??)}{[LING4170: Linguistics specialization on structure and form]}\\
...
\begin{cvsection}
  % 2025  & \Note{\textbf{Linguistic theories} \hfill(classes -- group size: ??)}{[LING2200: Lingvistiske teorier] -- classes on formal language theory and mathematical approaches in linguistics.}\\
