...
\begin{cvsection}
  2024 & \Note{\textbf{Grammatical relations in linguistic theory} \hfill(lecture -- group size: 4)}{[LING4130: Linguistics Specialization on variation] -- 1 lecture on Lexical Functional Grammar.}\\
  2024 & \Note{\textbf{Linguistic method}\hfill (lecture -- group size: 20)}{[LING4140: Språkvitenskapelig metode] -- 1 lecture on `Modelling in the language sciences'.}
\end{cvsection}
...
\begin{cvsection}
  2024 & \Note{\textbf{Semantics and pragmatics 2} \hfill(lectures -- group size: \textasciitilde{}10)}%
...
\Reff{lsa23-proceedings}{2023}{Yoolim Kim and Jamie Y. Findlay.
  ...
  \doi{10.3765/plsa.v8i1.5534}. \hfill[1 citation]}
