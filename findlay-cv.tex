...
\begin{cvsection}
  2015--2019 & \Note{%
    ...
    Examiners: Tom Wasow, Stephen Pulman
...
\begin{cvsection}
  2017 & \Note{%
    ...
    {Mapped to Descriptor 1 of the UK Professional Standards Framework: equivalent to Associate Fellow of\\[-0.5em] the Higher Education Academy.\\
...
\\[1em]
In this section, years shown stand for the academic year which starts in that calendar year (e.g. 2017 = the 2017/18 academic year).
...
\begin{cvsection}
      2018	      &	FHS psycholinguistics (co-ordinating and delivering tutorial teaching, as well as setting and marking the final exam).\\
\end{cvsection}
...
\begin{cvsection}
  ...
  2014, 2018  &	\Note{%
                ...
                {An introductory course which covers topics in general linguistics proper, along with psycholinguistics,\\[-0.5em] semantics \& pragmatics, sociolinguistics, and historical
                linguistics.}\\
  2014, 2018  &	\Note{%
...
\begin{cvsection}
  ...
  2018        & Member of Undergraduate Studies Committee, Faculty of
                Linguistics, Philology \& Phonetics, University of Oxford.\\
  2015--2018  & Admissions interviewing for undergraduate degrees involving
