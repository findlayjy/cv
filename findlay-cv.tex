...
\note\ At Oxford, `Prelims' = first year undergraduate level; `FHS (Final Honour School)' = advanced undergraduate level. In this section, years shown stand for the academic year which starts in that calendar year (e.g. 2017 = the 2017/18 academic year).

\subsubsection*{Syntax}
\begin{cvsection}
  Since 2016  & Occasional lectures in undergraduate and graduate syntax.\\
  2014--2016  & FHS syntax tutorials (group size: 1--3).\\
  2015--2016  & Graduate `Introduction to syntax' practical classes (group size: \textasciitilde{}25).\\
  2014, 2018  &	\Note{%
                Prelims `Grammatical analysis' classes (group size: 3--6).}
...
\begin{cvsection}
  ...
  2017        & Prelims semantics \& pragmatics lectures.\\
  2017--2018  & \Note{%
...
\begin{cvsection}
  ...
  2017          & Graduate class in corpus methods in sociolinguistics (group size: 2).
\end{cvsection}

\subsubsection*{Psycholinguistics}
\begin{cvsection}
  % 2018        & Convenor and first examiner, FHS psycholinguistics exam.\\
...
\begin{cvsection}
  ...
  2014, 2018	&	\Note{%
                ...
                {An introductory course which covers topics in general linguistics proper, along with psycholinguistics, semantics \& pragmatics, sociolinguistics, and historical
                linguistics.}
\end{cvsection}
...
\begin{cvsection}
	2016--2017	& Workshop: `\LaTeX* basics'.\\
  %
	2016--2017	& \Note{%
...
\begin{cvsection}
  ...
  2018--2019  & Convenor and first examiner, FHS psycholinguistics exam, Faculty of Linguistics, Philology \& Phonetics, University of Oxford.\\
  2017--2018  & Co-founder and co-convenor, D.Phil. workshop, Faculty of Linguistics, Philology \& Phonetics, University of Oxford.\\
...
\Label{Abstract\\[-0.5ex] reviewer}   & \textit{Conference of the Student Organisation of Linguistics in Europe (ConSOLE)}~(2017), \textit{International Lexical Functional Grammar Conference} (2019).\\
...
\Ref*{lfg-chapter}{To appear}{Mary Dalrymple and Jamie Y. Findlay. Lexical Functional Grammar. In Andr\'{a}s Kert\'{e}sz, Edith Moravcsik, and Csilla R\'{a}kosi (eds.), \emph{Current approaches to syntax -- a comparative handbook}. De Gruyter Mouton.}
