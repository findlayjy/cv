...
\vspace{0.2\squish}
%
\cvsubhead{Institution-level roles}
\begin{cvsection}
...
\Reff*{lfg-as-a-cxg}{Under review}{Jamie Y. Findlay. Lexical Functional Grammar
  as a Construction Grammar. Submitted to \textit{Journal of Language Modelling}.}

\Reff*{unlu-udw-23}{Under review}{Jamie Y. Findlay, Ahmet Y\i{}ld\i{}r\i{}m,
  Saeedeh Salimifar and Dag T. T. Haug. Rule-based semantic interpretation for
  Universal Dependencies. Submitted to \textit{Proceedings of the Sixth Workshop
    on Universal Dependencies (UDW 2023)}. Association for Computational
  Linguistics.}

\Reff*{semantics-for-dep-gram}{Under review}{Dag T. T. Haug and Jamie Y.
  Findlay. Semantics for Dependency Grammar. Submitted to \textit{Proceedings of
    the Seventh International Conference on Dependency Linguistics (Depling
