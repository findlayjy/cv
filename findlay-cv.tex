...
\newcommand{\myrepo}{https://docs.google.com/viewer?url=https://github.com/findlayjy/papers/raw/main/research} % github
...
\subsection*{In preparation}
  ...
  \Reff*{unlu-udw-23}{To appear}{Jamie Y. Findlay, Saeedeh
    Salimifar, Ahmet Y\i{}ld\i{}r\i{}m and Dag T. T. Haug. \mylink{findlay_etal-udw23-draft.pdf}{Rule-based semantic interpretation for
    Universal Dependencies}. To appear in \textit{Proceedings of the Sixth Workshop
      on Universal Dependencies (UDW 2023)}. Association for Computational
    Linguistics.}

  \Reff*{semantics-for-dep-gram}{To appear}{Dag T. T. Haug and Jamie Y. Findlay.
    \mylink{haug_findlay-depling23-draft.pdf}{Semantics for Dependency Grammar}. To appear in \textit{Proceedings of the
      Seventh International Conference on Dependency Linguistics (Depling
  ...
  \Reff*{arg-str-handbook-chapter}{Under review}{Jamie Y. Findlay, Anna Kibort and
    Roxanne Taylor. \mylink{findlay_etal-arg-str-ch-draft.pdf}{Argument
      structure and Mapping Theory}. In Mary Dalrymple (ed.), \emph{Handbook
      of Lexical Functional Grammar}. Language Science Press.}

  \Reff*{lfg-tag-chapter}{Under review}{Jamie Y. Findlay.
    \mylink{findlay-tag-lfg-ch-draft.pdf}{LFG and Tree Adjoining Grammar}. In
    Mary Dalrymple (ed), \emph{Handbook of Lexical Functional Grammar}.
    Language Science Press.}

  \Reff*{lsa23-proceedings}{In prep.}{Yoolim Kim and Jamie Y. Findlay. On the
    `subject' honorific \textit{-si-} in Korean. To be submitted to
    \textit{Proceedings of the Linguistic Society of America} 8(1).}
...
\Reff{lfg22-paper}{2022}{Jamie Y. Findlay \& Dag T. T. Haug.
  ...
  Findlay, and Ida Toivonen (eds.), \emph{Proceedings of the LFG'22 Conference}, 143--163.
  Stanford, CA: CSLI Publications.}

\Reff{depling21}{2022}{Jamie Y. Findlay \& Dag T. T. Haug.
