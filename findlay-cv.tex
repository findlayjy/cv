...
I have taught \textbf{syntax}, \textbf{semantics \& pragmatics}, \textbf{sociolinguistics}, \textbf{psycholinguistics}, and \textbf{general linguistics} at various levels, including designing tutorial courses and lecture series. My teaching experience covers small group and tutorial settings, larger classes, and lectures. I hold a SEDA-PDF Supporting Learning award (see above).
...
\Ref*{idiom-extensions-paper}{In preparation}{Jamie Y. Findlay, Sascha Bargmann and Manfred Sailer. The double life of idioms: lexical encoding, metaphor, and analogy in the analysis of VP idioms.}
...
\Ref*{europhras2019-talk}{(24\slash25 Jan., 2019)}{Why the butterflies in your stomach can have big wings: combining formal and cognitive theories to explain productive extensions of idioms. Joint work with Sascha Bargmann and Manfred Sailer. To be presented at the International Conference of the Europ\"{a}ische Gesellschaft f\"{u}r Phraseologie (EUROPHRAS 2019), Santiago de Compostela, Spain.}
\newpage
...
\Ref*{manchester-seminar}{27 Nov., 2018\slides{manchester-lel-seminar.pdf}}{When the cat you let out of the bag has claws: the role of metaphor in understanding idioms. To be presented at the Linguistics and English Language Research Seminar, University of Manchester.}
