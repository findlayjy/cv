...
\Ref{lfg-chapter}{2019\oa{green}{http://users.ox.ac.uk/~cpgl0015/DalrympleFindlay.pdf}}{Mary Dalrymple and Jamie Y. Findlay. Lexical Functional Grammar. In Andr\'{a}s Kert\'{e}sz, Edith Moravcsik, and Csilla R\'{a}kosi (eds.), \emph{Current approaches to syntax -- a comparative handbook}. De Gruyter Mouton.}
