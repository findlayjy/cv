...
\Reff*{lfg23-paper}{In prep.}{Jamie Y. Findlay. Lexical integrity is the norm:
  or, ``violating lexical integrity in a specific and limited way''. To be
  submitted to \textit{Proceedings of the LFG'23 Conference}.}
...
\Reff{lfg2017}{2017}{Jamie Y. Findlay. \href{http://web.stanford.edu/group/cslipublications/cslipublications/LFG/LFG-2017/lfg2017-findlay.pdf}{Multiword
  ...
  Publications. \hfill[2 citations]}
...
\Reff*{konstanz-colloquium-2023}{16 Nov., 2023}{The continued relevance of
  rule-based semantic parsing in the age of deep learning: an introduction to
  the Universal Natural Language Understanding project. To be presented at the
...
\Reff*{frankfurt-obserseminar-parsing}{13 Nov., 2023}{Parsing, fast and slow: a
  two-systems approach to some topics in linguistics. To be presented at the
  Obserseminar Syntax and Semantics, Goethe-Universit\"{a}t Frankfurt am Main.}
