...
\Reff*{lfg-tag-chapter}{In press}{Jamie Y. Findlay.
  \mydraftslink{findlay-tag-lfg-ch-prepub.pdf}{LFG and Tree Adjoining Grammar}. In Mary
  Dalrymple (ed), \emph{Handbook of Lexical Functional Grammar}. Language
  Science Press.}

\Reff*{arg-str-handbook-chapter}{In press}{Jamie Y. Findlay, Anna Kibort and
  Roxanne Taylor. \mydraftslink{findlay_etal-arg-str-ch-prepub.pdf}{Argument structure
...
\Reff{arg-str-paper}{2016}{Jamie Y. Findlay.
  ...
  \doi{10.15398/jlm.v4i2.171}. \hfill[43 citations]}
